...
<!--      密码-->
      <el-form-item prop="password">
        <el-input v-model="loginForm.password" prefix-icon="el-icon-lock" type="show-password"></el-input>
      </el-form-item>
<!--      按钮-->
...
data(){
  return{
    ...
    loginFormRules:{
      ...
      password:[
        { required: true, message: '请输入登录名称', trigger: 'blur' },{ min: 6, max: 15,message: '长度在 6 到 15 个字符', trigger: 'blur' }
      ]
    }
  }
},
